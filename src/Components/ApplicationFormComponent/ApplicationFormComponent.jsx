  ...
  return (
    <div className="mainbodyapplication">
      <div className="badge">
        ...
        <Box className="mailicon" sx={{ color: "action.active" }}>
      ...
      <div className="checkbox">
        ...
        <FormGroup>
          ...
          <FormControlLabel control={<Checkbox />} label="C Programming" />
          <FormControlLabel control={<Checkbox />} label="Pyhon" />
        </FormGroup>
      </div>
      <div>
        <p>Enter Age : </p>
      ...
      <div className="ratings">
        <p>Rate yourself in terms of performance for first quarter : </p>
        <Rating
      ...
      <div>
        <Box sx={{ width: 300 }}>
          <p>Select number less than 80 : </p>
          <Slider
